from pm.isaac_utils import torch_utils, rotations
...
from pm.envs.env_utils.path_generator import PathGenerator
from phc.utils.motion_lib_smpl import MotionLibSMPL as MotionLib
from typing import TYPE_CHECKING

if TYPE_CHECKING:
    from pm.envs.pm_inversion.path_follower.isaacgym import (
...
class BaseMaskedMimicPathFollowing(MaskedMimicPathFollowingHumanoid):  # type: ignore[misc]
    ...
    def fetch_path_samples(self, env_ids=None):
        ...
        timesteps = torch.arange(
            self.config.path_follower_params.num_traj_samples, device=self.device, dtype=torch.float
        )
